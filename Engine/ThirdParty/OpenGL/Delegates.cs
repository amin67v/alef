...
{
    unsafe internal static class Delegates
    {
        ...
        internal delegate void BeginQueryIndexed(uint target, uint index, uint id);
        ...
        internal delegate void BufferData(BufferTarget target, int size, IntPtr data, BufferUsageHint usage);
        ...
        internal delegate void ClearNamedFramebufferfi(uint framebuffer, ClearBuffer buffer, float depth, int stencil);
        ...
        internal delegate void GenFramebuffers(int n, [Out] uint[] ids);
        ...
        internal delegate void GenSamplers(int n, [Out] uint[] samplers);
        ...
        internal delegate void Getboolv(GetPName pname, [Out] bool[] data);
        internal delegate void Getdoublev(GetPName pname, [Out] double[] data);
        internal delegate void GetFloatv(GetPName pname, [Out] float[] data);
        internal delegate void GetIntegerv(GetPName pname, [Out] int[] data);
        internal delegate void GetInteger64v(ArbSync pname, [Out] long[] data);
        internal delegate void Getbooli_v(GetPName target, uint index, [Out] bool[] data);
        internal delegate void GetIntegeri_v(GetPName target, uint index, [Out] int[] data);
        internal delegate void GetFloati_v(GetPName target, uint index, [Out] float[] data);
        internal delegate void Getdoublei_v(GetPName target, uint index, [Out] double[] data);
        internal delegate void GetInteger64i_v(GetPName target, uint index, [Out] long[] data);
        internal delegate void GetActiveAtomicCounterBufferiv(uint program, uint bufferIndex, AtomicCounterParameterName pname, [Out] int[] @params);
        ...
        internal delegate void GetActiveSubroutineUniformiv(uint program, ShaderType shadertype, uint index, SubroutineParameterName pname, [Out] int[] values);
        ...
        internal delegate void GetActiveUniformsiv(uint program, int uniformCount, [Out] uint[] uniformIndices, ActiveUniformType pname, [Out] int[] @params);
        ...
        internal delegate void GetBufferParameteriv(BufferTarget target, BufferParameterName value, [Out] int[] data);
        internal delegate void GetBufferParameteri64v(BufferTarget target, BufferParameterName value, [Out] long[] data);
        internal delegate void GetNamedBufferParameteriv(uint buffer, BufferParameterName pname, [Out] int[] @params);
        internal delegate void GetNamedBufferParameteri64v(uint buffer, BufferParameterName pname, [Out] long[] @params);
        internal delegate void GetBufferPointerv(BufferTarget target, BufferPointer pname, [Out] IntPtr @params);
        internal delegate void GetNamedBufferPointerv(uint buffer, BufferPointer pname, [Out] IntPtr @params);
        internal delegate void GetBufferSubData(BufferTarget target, IntPtr offset, IntPtr size, [Out] IntPtr data);
        internal delegate void GetNamedBufferSubData(uint buffer, IntPtr offset, int size, [Out] IntPtr data);
        internal delegate void GetCompressedTexImage(TextureTarget target, int level, [Out] IntPtr pixels);
        internal delegate void GetnCompressedTexImage(TextureTarget target, int level, int bufSize, [Out] IntPtr pixels);
        internal delegate void GetCompressedTextureImage(uint texture, int level, int bufSize, [Out] IntPtr pixels);
        internal delegate void GetCompressedTextureSubImage(uint texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int bufSize, [Out] IntPtr pixels);
        ...
        internal delegate void GetNamedFramebufferAttachmentParameteriv(uint framebuffer, FramebufferAttachment attachment, FramebufferParameterName pname, [Out] int[] @params);
        internal delegate void GetFramebufferParameteriv(FramebufferTarget target, FramebufferPName pname, [Out] int[] @params);
        internal delegate void GetNamedFramebufferParameteriv(uint framebuffer, FramebufferPName pname, [Out] int[] param);
        internal delegate GraphicResetStatus GetGraphicsResetStatus();
        internal delegate void GetInternalformativ(TextureTarget target, PixelInternalFormat internalFormat, GetPName pname, int bufSize, [Out] int[] @params);
        internal delegate void GetInternalformati64v(TextureTarget target, PixelInternalFormat internalFormat, GetPName pname, int bufSize, [Out] long[] @params);
        internal delegate void GetMultisamplefv(GetMultisamplePName pname, uint index, [Out] float[] val);
        internal delegate void GetObjectLabel(ObjectLabelEnum identifier, uint name, int bifSize, [Out] int[] length, [Out] StringBuilder label);
        internal delegate void GetObjectPtrLabel([Out] IntPtr ptr, int bifSize, [Out] int[] length, [Out] StringBuilder label);
        internal delegate void GetPointerv(GetPointerParameter pname, [Out] IntPtr @params);
        internal delegate void GetProgramiv(uint program, ProgramParameter pname, [Out] int[] @params);
        internal delegate void GetProgramBinary(uint program, int bufsize, [Out] int[] length, [Out] int[] binaryFormat, [Out] IntPtr binary);
        internal delegate void GetProgramInfoLog(uint program, int maxLength, [Out] int[] length, [Out] StringBuilder infoLog);
        internal delegate void GetProgramInterfaceiv(uint program, ProgramInterface programInterface, ProgramInterfaceParameterName pname, [Out] int[] @params);
        internal delegate void GetProgramPipelineiv(uint pipeline, int pname, [Out] int[] @params);
        internal delegate void GetProgramPipelineInfoLog(uint pipeline, int bufSize, [Out] int[] length, [Out] StringBuilder infoLog);
        internal delegate void GetProgramResourceiv(uint program, ProgramInterface programInterface, uint index, int propCount, [Out] ProgramResourceParameterName[] props, int bufSize, [Out] int[] length, [Out] int[] @params);
        ...
        internal delegate void GetProgramResourceName(uint program, ProgramInterface programInterface, uint index, int bufSize, [Out] int[] length, [Out] StringBuilder name);
        internal delegate void GetProgramStageiv(uint program, ShaderType shadertype, ProgramStageParameterName pname, [Out] int[] values);
        ...
        internal delegate void GetNamedRenderbufferParameteriv(uint renderbuffer, RenderbufferParameterName pname, [Out] int[] @params);
        internal delegate void GetSamplerParameterfv(uint sampler, int pname, [Out] float[] @params);
        internal delegate void GetSamplerParameteriv(uint sampler, int pname, [Out] int[] @params);
        internal delegate void GetSamplerParameterIiv(uint sampler, TextureParameterName pname, [Out] int[] @params);
        internal delegate void GetSamplerParameterIuiv(uint sampler, TextureParameterName pname, [Out] uint[] @params);
        internal delegate void GetShaderiv(uint shader, ShaderParameter pname, [Out] int[] @params);
        internal delegate void GetShaderInfoLog(uint shader, int maxLength, [Out] int[] length, [Out] StringBuilder infoLog);
        internal delegate void GetShaderPrecisionFormat(ShaderType shaderType, int precisionType, [Out] int[] range, [Out] int[] precision);
        ...
        internal delegate void GetnTexImage(TextureTarget target, int level, PixelFormat format, PixelType type, int bufSize, [Out] IntPtr pixels);
        internal delegate void GetTextureImage(uint texture, int level, PixelFormat format, PixelType type, int bufSize, [Out] IntPtr pixels);
        internal delegate void GetTexLevelParameterfv(GetPName target, int level, GetTextureLevelParameter pname, [Out] float[] @params);
        internal delegate void GetTexLevelParameteriv(GetPName target, int level, GetTextureLevelParameter pname, [Out] int[] @params);
        internal delegate void GetTextureLevelParameterfv(uint texture, int level, GetTextureLevelParameter pname, [Out] float[] @params);
        internal delegate void GetTextureLevelParameteriv(uint texture, int level, GetTextureLevelParameter pname, [Out] int[] @params);
        ...
        internal delegate void GetTextureParameterfv(uint texture, GetTextureParameter pname, [Out] float[] @params);
        internal delegate void GetTextureParameteriv(uint texture, GetTextureParameter pname, [Out] int[] @params);
        internal delegate void GetTextureParameterIiv(uint texture, GetTextureParameter pname, [Out] int[] @params);
        internal delegate void GetTextureParameterIuiv(uint texture, GetTextureParameter pname, [Out] uint[] @params);
        internal delegate void GetTextureSubImage(uint texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, PixelFormat format, PixelType type, int bufSize, [Out] IntPtr pixels);
        internal delegate void GetTransformFeedbackiv(uint xfb, TransformFeedbackParameterName pname, [Out] int[] param);
        internal delegate void GetTransformFeedbacki_v(uint xfb, TransformFeedbackParameterName pname, uint index, [Out] int[] param);
        internal delegate void GetTransformFeedbacki64_v(uint xfb, TransformFeedbackParameterName pname, uint index, [Out] long[] param);
        ...
        internal delegate void GetnUniformfv(uint program, int location, int bufSize, [Out] float[] @params);
        internal delegate void GetnUniformiv(uint program, int location, int bufSize, [Out] int[] @params);
        internal delegate void GetnUniformuiv(uint program, int location, int bufSize, [Out] uint[] @params);
        internal delegate void GetnUniformdv(uint program, int location, int bufSize, [Out] double[] @params);
        ...
        internal delegate void GetUniformSubroutineuiv(ShaderType shadertype, int location, [Out] uint[] values);
        internal delegate void GetVertexArrayIndexed64iv(uint vaobj, uint index, VertexAttribParameter pname, [Out] long[] param);
        internal delegate void GetVertexArrayIndexediv(uint vaobj, uint index, VertexAttribParameter pname, [Out] int[] param);
        internal delegate void GetVertexArrayiv(uint vaobj, VertexAttribParameter pname, [Out] int[] param);
        ...
        internal delegate void ObjectLabel(ObjectLabelEnum identifier, uint name, int length, string label);
        ...
        internal delegate void QueryCounter(uint id, int target);
        internal delegate void ReadBuffer(ReadBufferMode mode);
        internal delegate void NamedFramebufferReadBuffer(uint framebuffer, BeginMode mode);
        ...
        internal delegate void RenderbufferStorage(RenderbufferTarget target, RenderbufferStorageEnum internalFormat, int width, int height);
        internal delegate void NamedRenderbufferStorage(uint renderbuffer, RenderbufferStorageEnum internalFormat, int width, int height);
        internal delegate void RenderbufferStorageMultisample(RenderbufferTarget target, int samples, RenderbufferStorageEnum internalFormat, int width, int height);
        internal delegate void NamedRenderbufferStorageMultisample(uint renderbuffer, int samples, RenderbufferStorageEnum internalFormat, int width, int height);
        ...
        internal delegate void SamplerParameterf(uint sampler, int pname, float param);
        internal delegate void SamplerParameteri(uint sampler, int pname, int param);
        internal delegate void SamplerParameterfv(uint sampler, int pname, float[] @params);
        internal delegate void SamplerParameteriv(uint sampler, int pname, int[] @params);
        ...
        internal delegate void TexImage2D(TextureTarget target, int level, PixelInternalFormat internalFormat, int width, int height, int border, PixelFormat format, PixelType type, IntPtr data);
        ...
        internal delegate void VertexAttribFormat(uint attribindex, int size, VertexAttribFormatEnum type, bool normalized, uint relativeoffset);
        internal delegate void VertexAttribIFormat(uint attribindex, int size, VertexAttribFormatEnum type, uint relativeoffset);
        internal delegate void VertexAttribLFormat(uint attribindex, int size, VertexAttribFormatEnum type, uint relativeoffset);
        internal delegate void VertexArrayAttribFormat(uint vaobj, uint attribindex, int size, VertexAttribFormatEnum type, bool normalized, uint relativeoffset);
        internal delegate void VertexArrayAttribIFormat(uint vaobj, uint attribindex, int size, VertexAttribFormatEnum type, uint relativeoffset);
        internal delegate void VertexArrayAttribLFormat(uint vaobj, uint attribindex, int size, VertexAttribFormatEnum type, uint relativeoffset);
        ...
        internal static Getboolv glGetboolv;
        ...
        internal static Getbooli_v glGetbooli_v;
