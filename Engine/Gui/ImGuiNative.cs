...
namespace Engine
{
    static unsafe class ImGui
    {
        ...
        public static extern bool igBegin(string name, IntPtr p_opened, WindowFlags flags);
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        ...
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void igSetNextWindowPos(Vector2 pos, GuiCondition cond);
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void igSetNextWindowPosCenter(GuiCondition cond);
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void igSetNextWindowSize(Vector2 size, GuiCondition cond);
        ...
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void igSetNextWindowCollapsed(bool collapsed, GuiCondition cond);
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void igSetNextWindowFocus();
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void igSetWindowPos(Vector2 pos, GuiCondition cond);  //(not recommended)
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void igSetWindowSize(Vector2 size, GuiCondition cond); //(not recommended)
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void igSetWindowCollapsed(bool collapsed, GuiCondition cond); //(not recommended)
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void igSetWindowFocus(); //(not recommended)
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void igSetWindowPosByName(string name, Vector2 pos, GuiCondition cond);
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void igSetWindowSize2(string name, Vector2 size, GuiCondition cond);
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void igSetWindowCollapsed2(string name, bool collapsed, GuiCondition cond);
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void igSetNextTreeNodeOpen(bool opened, GuiCondition cond);
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        ...
        */
        ...
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void ImFontConfig_DefaultConstructor(IntPtr config);
        ...
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern NativeFont* ImFontAtlas_AddFont(NativeFontAtlas* atlas, FontConfig* font_cfg);
        ...
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Vertex* ImDrawList_GetVertexPtr(NativeDrawList* list, int n);
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void ImDrawList_AddImage(NativeDrawList* list, IntPtr user_texture_id, Vector2 a, Vector2 b, Vector2 uv_a, Vector2 uv_b, uint col);
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void ImDrawList_AddImageQuad(NativeDrawList* list, IntPtr user_texture_id, Vector2 a, Vector2 b, Vector2 c, Vector2 d, Vector2 uv_a, Vector2 uv_b, Vector2 uv_c, Vector2 uv_d, uint col);
        [DllImport(cimguiLib, CallingConvention = CallingConvention.Cdecl)]
    ...
    unsafe delegate void ImDrawCallback(DrawList* parent_list, DrawCmd* cmd);
}
